...
class AddAnggotaKK extends StatefulWidget {
  const AddAnggotaKK({super.key});

  @override
  State<AddAnggotaKK> createState() => _AddAnggotaKKState();
}

class _AddAnggotaKKState extends State<AddAnggotaKK> {
                            ...
                            Alert(
                                ...
                                buttons: [
                                  DialogButton(
                                      ...
                                      context,
                                      MaterialPageRoute(builder: (context) => ShowKependudukan()),
